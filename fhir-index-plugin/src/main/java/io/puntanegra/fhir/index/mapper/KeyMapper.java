...
public final class KeyMapper {
	...
	/**
	 * The type of the primary key, which is composed by token, partition key
	 * and clustering key types.
	 */
	...
	/**
	 * Returns the {@link KeyEntry} represented by the specified Lucene
	 * {@link BytesRef}.
	 *
	 * @param bytesRef
	...
	/**
	 * Returns the {@code String} human-readable representation of the specified
	 * {@link ClusteringPrefix}.
	 *
	 * @param prefix
	...
	/**
	 * Returns the {@link ByteBuffer} representation of the primary key formed
	 * by the specified partition key and the clustering key.
	 *
	 * @param key
	 *            the partition key
	 * @param clustering
	...
	public ByteBuffer byteBuffer(DecoratedKey key, Clustering clustering) {
		return type.builder().add(TokenMapper.byteBuffer(key.getToken())).add(key.getKey()).add(byteBuffer(clustering))
				.build();
	}
	...
	/**
	 * Adds to the specified Lucene {@link Document} the primary key formed by
	 * the specified partition key and the clustering key.
	 *
	 * @param document
	 *            the Lucene {@link Document} in which the key is going to be
	 *            added
	 * @param key
	 *            the partition key
	 * @param clustering
	...
	/**
	 * Returns the Lucene {@link Term} representing the primary key formed by
	 * the specified partition key and the clustering key.
	 *
	 * @param key
	 *            the partition key
	...
	/**
	 * Returns the start {@link ClusteringPrefix} of the first partition of the
	 * specified {@link DataRange}.
	 *
	 * @param dataRange
	 *            the data range
	 * @return the start clustering prefix of {@code dataRange}, or {@code null}
	...
	/**
	 * Returns the stop {@link ClusteringPrefix} of the last partition of the
	 * specified {@link DataRange}.
	 *
	 * @param dataRange
	 *            the data range
	 * @return the stop clustering prefix of {@code dataRange}, or {@code null}
	 *         if there is no such start
	 */
	...
	/**
	 * Returns the {@link Term} representing the primary key of the specified
	 * {@link Document}.
	 *
	 * @param document
	 *            the document
