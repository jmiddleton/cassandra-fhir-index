...
/**
 * Class wrapping a Lucene RAM directory and its readers, writers and searchers
 * for NRT.
 *
...
public class LuceneRAMIndex {
	...
	/**
	 * Builds a new {@link LuceneRAMIndex}.
	 *
	 * @param analyzer
	...
	public void add(Document document) {
		try {
			...
			throw new FhirIndexException(e, "Error while indexing %s", document);
		}
	}
	...
	public void close() {
		try {
			...
			throw new FhirIndexException(e, "Error while closing");
		}
	}
